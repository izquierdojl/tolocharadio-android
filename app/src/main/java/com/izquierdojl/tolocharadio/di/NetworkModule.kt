...
import com.izquierdojl.tolocharadio.data.remote.DefaultInstanceApiFactory
...
/**
 * Red contra el servidor activo con autenticación por servidor. La
 * base se lee una vez al crear el grafo; al cambiar de servidor la
 * app se reinicia (rebirth).
 */
@Module
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun instanceApiFactory(): InstanceApiFactory = DefaultInstanceApiFactory()
