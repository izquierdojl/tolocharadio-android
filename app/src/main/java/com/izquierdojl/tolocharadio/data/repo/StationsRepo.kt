...
import com.izquierdojl.tolocharadio.data.local.CachedStation
...
class StationsRepo
    ...
    constructor(
        ...
        private suspend fun strings(
            call: suspend () -> retrofit2.Response<com.izquierdojl.tolocharadio.data.remote.dto.StringListDto>,
        ...
        private suspend fun fromCache(query: StationQuery): ApiResult<StationPageDto>? {
            ...
            return ApiResult.Ok(
                StationPageDto(
                    ...
                    pagination =
                        com.izquierdojl.tolocharadio.data.remote.dto.PaginationDto(
                            offset = query.offset,
                            limit = query.limit,
                            hasMore = false,
                        ),
