...
object NotificationLogger {
     ...
     */
    fun logNotificationCreated(type: NotificationType, title: String) {
     ...
     */
    fun logNotificationTapped(type: NotificationType, action: NotificationAction, contentId: String?) {
     ...
     */
    fun logNavigation(action: NotificationAction, deepLink: String) {
     ...
     */
    fun logAppStateChange(oldState: AppState, newState: AppState) {
