...
object RetrofitFactory {
    fun create(
        baseUrl: String,
        session: com.example.tolocharadio.core.session.SessionManager,
        tokens: com.example.tolocharadio.core.session.TokenStore,
        authApi: dagger.Lazy<com.example.tolocharadio.data.remote.api.AuthApi>,
        debug: Boolean,
    ): Retrofit {
        val logging =
