...
5. **Resultado esperado**: El icono cambia a reloj activo con badge "15:00"
...
2. **Resultado esperado**: Se muestra "Quedan MM:SS" y opción "Cancelar temporizador"
...
4. **Resultado esperado**: El badge cambia a "15:00", el timer anterior se cancela
...
1. Activa un temporizador de 15 segundos (debug)
